...
import { api, type SharedSimulationDetail, type SharedSimulationSummary } from "../api";
import { downloadSimulationPDF } from "./SimulationPDFExport"; // ← add this
...
export default function PatientSimulations() {
  ...
  const chartRef = useRef<HTMLDivElement>(null);         // ← add this
  const token = localStorage.getItem("patient_token") || "";
    ...
    <div style={{ maxWidth: "960px", margin: "0 auto" }}>
      ...
      {detail && (
        <>
          ...
          <div
            ref={chartRef} // ← the only change to your existing chart block
